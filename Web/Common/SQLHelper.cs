...
namespace Web
{
    ...
    public  class SQLHelper
    {
        ...
        {
            return ExecuteNonQuery(connectionString, CommandType.Text, commandText, para);
        }
        ...
        public static DataTable ExecuteDataTable(string commandText)
        {
            ...
            return ExecuteDataset(connectionString, CommandType.Text, commandText, (SqlParameter[])null).Tables[0];
        }

        public static DataTable ExecuteDataTable(string commandText,params SqlParameter[] para)
        {

            return ExecuteDataset(connectionString, CommandType.Text, commandText,para).Tables[0];
        }
        /// <summary>
        ...
        public static SqlDataReader ExecuteReader(string commandText,params SqlParameter[] para)
        {
            ...
            return ExecuteReader(connectionString, CommandType.Text, commandText, para);
        }
        ...
        {
            return ExecuteScalar(connectionString, CommandType.Text, commandText, para);
        }
