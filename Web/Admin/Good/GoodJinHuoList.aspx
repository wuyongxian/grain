<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodJinHuoList.aspx.cs" Inherits="Web.Admin.Good.GoodJinHuoList" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../Scripts/My97DatePicker/WdatePicker.js" type="text/javascript"></script>
      <script type="text/javascript">
          ...
          function ShowUpdateQuanlity(ID,GoodID, WBID, Quanlity) {
              showBodyCenter($('#divfrm'));
              $('#btnSave').removeAttr('disabled');
              $('#txt_ID').val(ID);
              $('#txt_GoodID').val(GoodID);
              $('#txt_WBID').val(WBID);
          ...
          function FunUpdateQuanlity() {
              ...
              var GoodID = $('#txt_GoodID').val();
              var Quanlity = $('input[name=Quanlity]').val();
              var QuanlityOriginal = $('#txt_QuanlityOriginal').val();
              $.ajax({
                  url: '/Ashx/good.ashx?type=Update_GoodStockWB&ID=' + ID + '&WBID=' + WBID + '&GoodID=' + GoodID + '&Quanlity=' + Quanlity + '&QuanlityOriginal=' + QuanlityOriginal,
                  type: 'post',
                  data: '',
                  dataType: 'text',
                  success: function (r) {
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            ...
            <ItemTemplate>
                <tr 
                    ...
                    <td>
                        <%#GetUpdateItem(Eval("ID"),Eval("GoodID"),Eval("WBID"),Eval("Quantity"))%>
