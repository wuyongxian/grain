...
{
    public partial class GoodJinHuoListHQ : System.Web.UI.Page
    {
        ...
        private void DataBind()
        {
            ...
            strSql.Append("  LEFT OUTER JOIN dbo.BD_PackingSpec E ON C.PackingSpecID=E.ID");
            ...
            strSql.Append("    WHERE B.ISHQ=1 AND B.ISSimulate=0 ");
        ...
        private void outputExcel()
        {
            ...
            string fileName = "总部进货记录" + DateTime.Now.Year + DateTime.Now.Month + DateTime.Now.Day + ".xls";
