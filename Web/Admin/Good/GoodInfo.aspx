<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodInfo.aspx.cs" Inherits="Web.Admin.Good.GoodInfo" %>
...
//            $('input[name=strName]').removeAttr('disabled');
            ...
            $('input[name=Price_StockHQ]').val('0');
            $("input[name=ISIntegral]").removeAttr("checked");
            $('input[name=IntegralValue]').val('0');
            $('input[name=Price_StockHQ]').val('0');
...
//                    $('input[name=strName]').attr('disabled', 'disabled');
                    ...
                    $('input[name=Price_StockHQ]').val(r[0].Price_StockHQ);
                    if (r[0].ISIntegral) {
                        $("input[name=ISIntegral]").attr("checked", "checked");
                    }else{
                        $("input[name=ISIntegral]").removeAttr("checked");
                    }
                    $('input[name=IntegralValue]').val(r[0].IntegralValue);
        ...
        */
        ...
        function OpenJinHuo() {
            ...
            window.location = "/Admin/Good/goodjinhuo.html?GoodID=" + $('#WBID').val()+'&WBWareHouseID='+WBWareHouseID+'&WBSupplierID='+WBSupplierID;
        }
...
//            }
            ...
            if (!CheckNumDecimal($('input[name=Price_Stock]').val(),'分行进价', 2)) {
                return false;
            }
            if (!CheckNumDecimal($('input[name=Price_StockHQ]').val(),'总行进价', 2)) {
                return false;
            }
            if (!CheckNumDecimal($('input[name=IntegralValue]').val(),'兑换积分数', 2)) {
                return false;
            }
            ...
            if (!CheckNumDecimal($('input[name=numExchangeLimit]').val(), '兑换限额', 2)) {
                return false;
            }
            return true;
        }
        ...
        <div class="QueryHead">
            <table>
                <tr>
                    ...
                    <td><span>
                        <input type="text" id="txtstrName" runat="server" />
                    </span></td>
                    <td style="width: 60px">
            ...
            <HeaderTemplate>
                <table class="tabData">
                    <tr class="tr_head">
                        ...
                        <th style="width: 80px; text-align: center;">规格型号
                        </th>
                        <th style="width: 80px; text-align: center;">总部进价
                        </th>
                        <th style="width: 80px; text-align: center;">网点进价
                        </th>
                        <th style="width: 80px; text-align: center;">兑换价格
                        </th>
                        <th style="width: 80px; text-align: center;">销售价格
                        </th>
                       <%-- <th style="width: 80px; text-align: center;">批发价格
                        </th>--%>
                        <th style="width: 80px; text-align: center;">库存
                        </th>
                        <th style="width: 80px; text-align: center;">兑换限额
                        </th>
                         <th style="width: 80px; text-align: center;">兑换积分
                        </th>
                        <th style="width: 80px; text-align: center;">存储信息
                        </th>
                       
                        <th style="width: 80px; text-align: center;">查看/修改
                        </th>
                        <th style="width: 60px; text-align: center;">删除
                        </th>
                    </tr>
            </HeaderTemplate>
            <ItemTemplate>
                ...
                <table class="tabEdit">
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td>
                            <input name="Price_StockHQ" type="text" style="width: 100px;" />
                   ...
                   <tr style="display:none;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="IntegralValue" style="width: 100px;" />
            ...
            <div style="clear: both;">
                <table class="tabEdit">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="strName2" style="width: 200px;" /><span style="color: Red; font-weight: bolder;">*</span>
                        </td>
                    </tr>
