<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RStoreToSell.aspx.cs" Inherits="Web.Admin.Returned.RStoreToSell" %>
                 ...
                 showMsg(' 请选择要退还的信息 ！');
                  ...
                  showConfirm(msg, function (obj) {
                      if (obj == 'yes') {
                          ...
                          $.ajax({
                              url: '/Ashx/exchangeprop.ashx?type=Return_StorageSell&IDList=' + IDList,
                              type: 'post',
                              data: '',
                              dataType: 'text',
                              success: function (r) {
...
<body>
    ...
    <div class="pageHead">
        <b>退还储户存转销</b><span id="spanHelp" style="cursor: pointer">帮助</span>
    </div>
    <div id="divHelp" class="pageHelp">
        <span>提示1：首先找到储户信息与存转销 信息，选择对应的存转销退还</span><br />
        <span>提示2：营业员可以退还当日存转销数据，管理员可以按原数退还储户所有存转销数据</span><br />
    </div>
<div id="storageQuery">
    ...
    <div style="margin: 20px 0px;">
        ...
        <span style="font-size:16px; font-weight:bolder;">储户存转销信息</span>
        ...
        <div id="divNO"  runat="server" style="color:Red; font-weight:bold;display:none;">该储户没有存转销信息</div>
