...
{
    public partial class QByPhoneNO : System.Web.UI.Page
    {
        ...
        private void DataBind(int pageindex, int pagesize)
        {
            ...
            if (QPhoneNo.Value.Trim() != "")
            {
                strSql.Append("   AND B.PhoneNO LIKE '%" + QPhoneNo.Value.Trim() + "%'");
            }
        ...
        private void GetDataCount()
        {
            ...
            if (QPhoneNo.Value.Trim() != "")
            {
                strSql.Append("   AND B.strName LIKE '%" + QPhoneNo.Value.Trim() + "%'");
            }
            //if (QIDCard.Value.Trim() != "")
            //{
            //    strSql.Append("   AND B.IDCard LIKE '%" + QIDCard.Value.Trim() + "%'");
