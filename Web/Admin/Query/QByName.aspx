<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QByName.aspx.cs" Inherits="Web.Admin.Query.QByName" %>
        ...
        <div class="QueryHead">
            <table>
                <tr>
                    ...
                    <td>
                        <input type="text" id="QName" style="font-size: 16px; width: 100px; font-weight: bolder;" runat="server" /></td>
                    <td style="width: 60px">
