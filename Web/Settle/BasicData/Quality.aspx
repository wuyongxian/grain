<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Quality.aspx.cs" Inherits="Web.Settle.BasicData.Quality" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowFrm_Update(wbid) {
            ...
            /*----数据提交----*/
            $.ajax({
                url: '/Ashx/settlebasic.ashx?type=GetByID_Quality&ID=' + wbid,
                type: 'post',
                data: '',
                dataType: 'json',
                success: function (r) {
        ...
        function FunAdd() {
            ...
            SingleDataAdd('/Ashx/settlebasic.ashx?type=Add_Quality', $('#form1').serialize());
        ...
        function FunUpdate() {
            ...
            var wbid = $('#WBID').val();
            SingleDataUpdate('/Ashx/settlebasic.ashx?type=Update_Quality&ID=' + wbid, $('#form1').serialize());
          
        }

        //删除数据方法
        function FunDelete(wbid) {
            SingleDataDelete('/Ashx/settlebasic.ashx?type=DeleteByID_Quality&ID=' + wbid);
...
<body>
    ...
    <div class="pageHead">
       <b>质检人员管理</b><%--<span id="spanHelp" style="cursor: pointer">帮助</span>--%>
    </div>
