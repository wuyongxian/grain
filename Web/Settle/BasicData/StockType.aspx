<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockType.aspx.cs" Inherits="Web.Settle.BasicData.StockType" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowFrm_Update(wbid) {
            ...
            /*----数据提交----*/
            $.ajax({
                url: '/Ashx/settlebasic.ashx?type=GetByID_StockType&ID=' + wbid,
                type: 'post',
                data: '',
                dataType: 'json',
                success: function (r) {
        ...
        function FunAdd() {
            ...
            SingleDataAdd('/Ashx/settlebasic.ashx?type=Add_StockType', $('#form1').serialize());
        ...
        function FunUpdate() {
            ...
            var wbid = $('#WBID').val();
            SingleDataUpdate('/Ashx/settlebasic.ashx?type=Update_StockType&ID=' + wbid, $('#form1').serialize());
           
        }

        //删除数据方法
        function FunDelete(wbid) {
            SingleDataDelete('/Ashx/settlebasic.ashx?type=DeleteByID_StockType&ID=' + wbid);
...
<body>
    ...
    <div class="pageHead">
       <b>出库类型管理</b><%--<span id="spanHelp" style="cursor: pointer">帮助</span>--%>
    </div>
