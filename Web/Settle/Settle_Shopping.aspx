<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Settle_Shopping.aspx.cs" Inherits="Web.Settle.Settle_Shopping" %>
    ...
    <script src="../../Scripts/excelhelper.js" type="text/javascript"></script>
      <script type="text/javascript">
          ...
          $(function () {
              ...
              $('#excel_export').ExportExcel('dataInfo', '网点商品换购结算报表');
          });
          function InitWBID() {
          ...
          function GetSettleSingle(obj) {
              ...
              $.ajax({
                  url: '/Ashx/settle.ashx?type=ISHaveShopping&ID=' + obj,
                  type: 'post',
                  data: '',
                  dataType: 'text',
                  success: function (r) {
          ...
          function ShowSettleSingle(obj) {
              ...
              $.ajax({
                  url: '/Ashx/settle.ashx?type=GetShoppingSingle&ID=' + obj,
                  type: 'post',
                  data: '',
                  dataType: 'json',
                  success: function (r) {
                      ...
                      if (ISReturn == 0) {
                          $('#S_VarietyMoney').html(r[0].VarietyMoney);
                          $('#S_VarietyMoney2').html(r[0].VarietyMoney);
                      }
                      else {
                          $('#S_VarietyMoney').html('-' + r[0].VarietyMoney);
                          $('#S_VarietyMoney2').html('-' + r[0].VarietyMoney);
          ...
          function FunPay() {
              ...
              showConfirm(msg, function (obj) {
                  if (obj == 'yes') {
                      ...
                      $.ajax({
                          url: '/Ashx/settle.ashx?type=AddSA_Shopping&ID=' + ID + '&Accountant=' + Accountant,
                          type: 'post',
          ...
          function FunPayAll() {
              ...
              showConfirm(msg, function (obj) {
                  if (obj == 'yes') {
                      ...
                      $.ajax({
                          url: '/Ashx/settle.ashx?type=AddSA_ShoppingAll&WBID=' + WBID + '&dtStart=' + dtStart + '&dtEnd=' + dtEnd,
                          type: 'post',
                          data: $('#form1').serialize(),
                          dataType: 'text',
                          success: function (r) {
          ...
          function PrintPage(obj) {
              ...
              $.ajax({
                  url: '/Ashx/settle.ashx?type=PrintShopping&ID=' + obj,
                  type: 'post',
                  data: '',
                  dataType: 'text',
                  success: function (r) {
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            ...
            <ItemTemplate>
                <tr  onmouseover="change_colorOver(this)" onmouseout="change_colorOut(this)">
                    ...
                    <td>
                        <%--  ￥<%#Eval("VarietyMoney")%>--%>
                      ￥<%#GetVarietyMoney(Eval("VarietyMoney"),Eval("ISReturn") )%>
                    </td>
                    <td>
                ...
                <tr>
                    <td style="height: 25px;">
                        ...
                        <td align="center" colspan="7">
                            <span style="color: Red; font-weight: bold;">产品换购结算合计:</span>
