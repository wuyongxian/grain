<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintSetting_Dep.aspx.cs" Inherits="Web.User.SystemControl.PrintSetting_Dep" %>
        ...
        function WBUpdate() {
            ...
            showConfirm(msg, function (obj) {
                if (obj == 'yes') {
                    ...
                    $.ajax({
                        url: '/Ashx/wbinfo.ashx?type=UpdatePrintSetting_Dep',
                        type: 'post',
        ...
        function GetModel() {
            ...
            showConfirm(msg, function (obj) {
                if (obj == 'yes') {
                    ...
                    $.ajax({
                        url: '/Ashx/wbinfo.ashx?type=SetWBPrintSetting_Dep',
                        type: 'post',
                        data: '',
                        dataType: 'text',
                        success: function (r) {
...
<div class="pageHead">
<b style="color:Red">储户</b><b>网点存折打印坐标设置</b>
</div>
