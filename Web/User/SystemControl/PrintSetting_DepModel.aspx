<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintSetting_DepModel.aspx.cs" Inherits="Web.User.SystemControl.PrintSetting_DepModel" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function InitPrintSetting() {
            $.ajax({
                url: '/Ashx/wbinfo.ashx?type=GetPrintSetting_DepModel',
                type: 'post',
                data: '',
                dataType: 'json',
                success: function (r) {
        ...
        function WBUpdate() {
            ...
            showConfirm(msg, function (obj) {
                if (obj == 'yes') {
                    ...
                    $.ajax({
                        url: '/Ashx/wbinfo.ashx?type=UpdatePrintSetting_DepModel',
                        type: 'post',
...
<div class="pageHead">
<b style="color:Red">储户</b><b>存折打印坐标模板设置</b>
</div>
