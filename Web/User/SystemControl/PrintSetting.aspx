<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintSetting.aspx.cs" Inherits="Web.User.SystemControl.PrintSetting" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function WBUpdate() {
            ...
            showConfirm(msg, function (obj) {
                if (obj == 'yes') {
                    ...
                    $.ajax({
                        url: '/Ashx/wbinfo.ashx?type=UpdatePrintSetting',
                        type: 'post',
        ...
        function GetModel() {
            var msg = '您确认要将本网店的社员打印坐标重置为系统模板的打印坐标吗？';
            showConfirm(msg, function (obj) {
                if (obj == 'yes') {
                    
                    $.ajax({
                        url: '/Ashx/wbinfo.ashx?type=SetWBPrintSetting',
                        type: 'post',
                        data: '',
                        dataType: 'text',
                        success: function (r) {
...
<div class="pageHead">
<b style="color:Red">社员</b><b>网店存折打印坐标设置</b>
</div>
    ...
    <div id="divfrm" >
        ...
        <table class="tabEdit"  style="margin:5px 0px;">
          ...
          <table class="tabEdit"  style="margin:5px 0px;">
            ...
            <input type="button" id="btnUpdate" value="修改" style="margin-left:120px;" onclick="WBUpdate()" />

              <input type="button" id="Button1" value="使用打印模板" style="margin-left:200px;" onclick="GetModel()" />
        </div>
