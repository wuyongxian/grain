<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userSupplyInfo.aspx.cs" Inherits="Web.User.Goods.userSupplyInfo" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            InitSelect('/Ashx/good.ashx?type=Get_WBWareHouse', 'WBWareHouseID', '加载仓库名称信息失败！'); //仓库名称
        ...
        function FunAdd() {
            ...
            SingleDataAdd('/Ashx/good.ashx?type=Add_GoodSupply', $('#form1').serialize());
        }
        ...
        function FunUpdate() {
            ...
            var wbid = $('#WBID').val();
            SingleDataUpdate('/Ashx/good.ashx?type=Update_GoodSupply&ID=' + wbid,$('#form1').serialize());
        ...
        */
        ...
        //打开进货界面
        function OpenJinHuo() {
            window.location = "/User/Goods/userSupplyJinHuo.aspx?GoodSupplyID=" + $('#WBID').val();
        }
...
<table>
          ...
          <%--  <td><a href="#" onclick="ShowFrm(0)">添加社员供销商品</a></td>--%>
            </tr>
