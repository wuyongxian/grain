<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userSupplyJinHuo.aspx.cs" Inherits="Web.User.Goods.userSupplyJinHuo" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function FunStock() {
            ...
            $.ajax({
                url: '/Ashx/good.ashx?type=GetHQStorage&GoodSupplyID=' + $('select[name=GoodID] option:selected').val(),
                type: 'post',
                data: '',
                dataType: 'text',
                success: function (r) {
                    ...
                    if (parseFloat(Quantity) > parseFloat(r)) {
                       showMsg('总部库存不足，无法出货 ！');
                        ...
                        /*----网店进货----*/
                        $.ajax({
                            url: '/Ashx/good.ashx?type=Add_GoodSupplyStockApply',
                            type: 'post',
      ...
      <div style="clear: both;">
            <table class="tabEdit">
                ...
                <tr>
                    ...
                    <td>
                    <span style="font-weight:bolder;" id="WBSupplierID">总部</span>
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input name="Price" type="text" onkeyup="calcSum()" readonly="readonly" style="width: 100px; background-color:#ddd;" />
                        <span>元/</span>
                 ...
                 <tr>
                    ...
                    <td>
                        <input name="Price_WB" type="text" onkeyup="calcSum()" readonly="readonly" style="width: 100px; background-color:#ddd;" />
                        <span>元/</span>
                 ...
                 <tr>
                    ...
                    <td>
                        <input name="Price_WBBack" type="text" onkeyup="calcSum()" readonly="readonly" style="width: 100px; background-color:#ddd;" />
                        <span>元/</span>
                ...
                <tr>
                    ...
                    <td>
                        <input type="button" id="btnStock" value="申请进货" onclick="FunStock()" />
                    </td>
                </tr>
