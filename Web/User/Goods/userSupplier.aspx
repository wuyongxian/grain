<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userSupplier.aspx.cs" Inherits="Web.User.Goods.userSupplier" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function FunAdd() {
            ...
            SingleDataAdd('/Ashx/good.ashx?type=Add_Supplier', $('#form1').serialize());
        ...
        function FunUpdate() {
            ...
            var wbid = $('#WBID').val();
            SingleDataUpdate('/Ashx/good.ashx?type=Update_Supplier&ID=' + wbid, $('#form1').serialize());
