<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MeasuringUnit.aspx.cs" Inherits="Web.BasicData.Data.MeasuringUnit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowFrm_Update(wbid) {
            ...
            /*----数据提交----*/
            $.ajax({
                url: 'addr.ashx?type=GetByID_Unit&ID=' + wbid,
                type: 'post',
                data: '',
                dataType: 'json',
                success: function (r) {
        ...
        function FunUpdate() {
            ...
            showConfirm(msg, function (obj) {
                if (obj == 'yes') {
                    ...
                    $.ajax({
                        url: 'addr.ashx?type=Update_Unit&ID=' + wbid,
                        type: 'post',
                        data: $('#form1').serialize(),
                        dataType: 'text',
                        success: function (r) {
        ...
        function FunDelete(wbid) {
            SingleDataDelete('addr.ashx?type=DeleteByID_Unit&ID=' + wbid);
        }
        //提交检测
...
<body>
    ...
    <div class="pageHead">
       <b>计价单位管理</b><%--<span id="spanHelp" style="cursor: pointer">帮助</span>--%>
    </div>
