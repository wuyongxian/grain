<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PackingSpec.aspx.cs" Inherits="Web.BasicData.Data.PackingSpec" %>
    ...
    <script type="text/javascript">
        ...
        function ShowFrm_Update(wbid) {
           // $('#divfrm').fadeIn();
            ...
            /*----数据提交----*/
            $.ajax({
                url: 'addr.ashx?type=GetByID_Spec&ID=' + wbid,
                type: 'post',
                data: '',
                dataType: 'json',
                success: function (r) {
        ...
        function FunUpdate() {
            ...
            showConfirm(msg, function (obj) {
                if (obj == 'yes') {
                    ...
                    $.ajax({
                        url: 'addr.ashx?type=Update_Spec&ID=' + wbid,
                        type: 'post',
                        data: $('#form1').serialize(),
                        dataType: 'text',
                        success: function (r) {
        ...
        function FunDelete(wbid) {
            SingleDataDelete('addr.ashx?type=DeleteByID_Spec&ID=' + wbid);
...
<body>
    ...
    <div class="pageHead">
       <b>产品规格管理</b><%--<span id="spanHelp" style="cursor: pointer">帮助</span>--%>
    </div>
