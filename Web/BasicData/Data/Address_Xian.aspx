<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Address_Xian.aspx.cs" Inherits="Web.BasicData.Data.Address_Xian" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowFrm_Update(wbid) {
            ...
            /*----数据提交----*/
            $.ajax({
                url: 'addr.ashx?type=GetByID_Address_Xian&ID=' + wbid,
                type: 'post',
                data: '',
                dataType: 'json',
                success: function (r) {
        ...
        function FunAdd() {
            ...
            SingleDataAdd('addr.ashx?type=Add_Address_Xian', $('#form1').serialize());
        ...
        function FunUpdate() {
            ...
            var wbid = $('#WBID').val();
            SingleDataUpdate('addr.ashx?type=Update_Address_Xian&ID=' + wbid, $('#form1').serialize());
        ...
        function FunDelete(wbid) {
            ...
            SingleDataDelete('addr.ashx?type=DeleteByID_Address_Xian&ID=' + wbid);
...
<body>
    ...
    <div class="pageHead">
       <b>县名管理</b><%--<span id="spanHelp" style="cursor: pointer">帮助</span>--%>
    </div>
